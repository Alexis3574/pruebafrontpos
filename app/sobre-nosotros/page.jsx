      ...
      <div className="bg-white flex flex-col min-h-screen">
        ...
        <main className=" flex flex-col items-center px-6 py-10 gap-10 flex-grow">
          ...
          <div className="flex flex-col md:flex-row gap-6 max-w-6xl w-full">
            <div className="bg-white w-full md:w-1/2 h-64 flex items-center justify-center rounded-lg">
            <Image
               src="/images/sae_itiz.png"
               alt="Imagen llamativa"
               width={300}
               height={300}
               className="object-contain"/>    
            </div>

            <div className="bg-emerald-100 shadow-lg p-6 rounded-xl w-full md:w-1/2">
              <p className="text-gray-700">
                Somos ITIZ-SAE, una solución tecnológica diseñada para ayudarte a mantener el control total
                de productos frescos en tu negocio. Nuestro enfoque es la eficiencia, la simplicidad y la reducción de pérdidas.
              </p>
            </div>
          </div>

          <div className="bg-emerald-100 shadow-lg rounded-xl p-6 max-w-4xl w-full space-y-6">
            <div>
